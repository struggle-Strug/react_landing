  ...
  return (
    <div className="w-full overflow-auto">
      <div className="flex place-content-center">
        <div className="relative w-full mx-3 md:w-4/5 mt-12 mb-6 sp:mt-10 sp:mb-6 flex flex-col items-center border-8 border-main">
          <div className="w-full text-white sp:h-[66px] flex flex-col justify-center items-center gap-1 sp:gap-1 font-CenturyGothic py-4 bg-main">
