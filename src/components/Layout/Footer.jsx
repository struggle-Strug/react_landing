...
export default function Footer() {
  return (
    <div className='text-white fixed bottom-0 z-30 w-full flex flex-col	sm:flex-row h-auto bg-main sm:justify-between first-letter:items-center py-[20px] px-[40px]'>
