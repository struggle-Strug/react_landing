                ...
                <div>
                  <div className="mt-3 sm:mt-5">
                    ...
                    <div className="mt-5 overflow-y-auto h-[60vh] text-sm text-gray-700">
                      ...
                      <ol className="list-outside list-decimal ml-6">
                        <li>当社は、前条の定めに関わらず、登録情報その他のユーザー様に関する情報（但し、個人情報に該当するものを除きます。）を、本サービスを含む当社が提供し又は提供しようとしているサービスの品質向上、これらのサービスに関するユーザー様へのご案内、その他当社が<a href='https://cuoremo.co.jp/privacy/' className="underline hover:underline-offset-4 font-semibold" target='__blank'>プライバシーポリシー</a>に定める目的で利用することができるものとします。</li>
