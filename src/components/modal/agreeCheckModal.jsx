                ...
                <div>
                  <div className="mt-3 sm:mt-5">
                    ...
                    <div className="mt-5 overflow-y-auto h-[60vh] text-sm text-gray-700">
                      ...
                      <ol className="list-outside list-decimal ml-6">
                        <li>当社は、ユーザー様から委託された個人情報の取扱いについては、当社が別途定める<a href='https://cuoremo.co.jp/privacy/' target='__blank'>プライバシーポリシー</a>（以下「<b>プライバシーポリシー</b>」といいます。）の定めによるものとし、ユーザー様はこの<a href='https://cuoremo.co.jp/privacy/' target='__blank'>プライバシーポリシー</a>に従って当社がユーザー様の利用者情報を取扱うことについて同意するものとします。</li>
                      ...
                      <ol className="list-outside list-decimal ml-6">
                        <li>当社は、前条の定めに関わらず、登録情報その他のユーザー様に関する情報（但し、個人情報に該当するものを除きます。）を、本サービスを含む当社が提供し又は提供しようとしているサービスの品質向上、これらのサービスに関するユーザー様へのご案内、その他当社が<a href='https://cuoremo.co.jp/privacy/' target='__blank'>プライバシーポリシー</a>に定める目的で利用することができるものとします。</li>
