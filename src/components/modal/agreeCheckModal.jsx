            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md sm:p-6">
                <div>
                  <div className="mt-3 sm:mt-5">
                    ...
                    <div className="mt-5 overflow-y-auto h-[70vh]">
                      ...
                      <ol className="list-outside list-decimal ml-6">
                        <li>当社は、ユーザー様から委託された個人情報の取扱いについては、当社が別途定めるプライバシーポリシー（以下「<b>プライバシーポリシー</b>」といいます。）の定めによるものとし、ユーザー様はこのプライバシーポリシーに従って当社がユーザー様の利用者情報を取扱うことについて同意するものとします。</li>
                      ...
                      <ol className="list-outside list-decimal ml-6">
                        <li>当社は、前条の定めに関わらず、登録情報その他のユーザー様に関する情報（但し、個人情報に該当するものを除きます。）を、本サービスを含む当社が提供し又は提供しようとしているサービスの品質向上、これらのサービスに関するユーザー様へのご案内、その他当社がプライバシーポリシーに定める目的で利用することができるものとします。</li>
                ...
                <div className="mt-5 sm:mt-6 items-center px-0 text-center text-sm sm:px-12">
                  ...
                  <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-none mt-3"
